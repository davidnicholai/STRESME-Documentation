...
% Some notes on citing the references.   When using APA format, the author-date method of citation is 
...
You may refer to the figure for example as follows:  \figref{fig:disneystock} shows a graph of the 
...
%  Example: 
%      
%   To develop racing strategies for Sinag2 various conditions.
%
%
